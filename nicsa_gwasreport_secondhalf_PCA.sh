...
#SBATCH --export ALL
#SBATCH -o /tscc/projects/ps-palmer/brittany/SUD_cross_species/$nicsa_porcupine.o
#SBATCH -e /tscc/projects/ps-palmer/brittany/SUD_cross_species/$nicsa_porcupine.e  
